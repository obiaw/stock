# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-07 12:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_serial', models.CharField(blank=True, max_length=100, null=True, verbose_name='Asset Serial Number')),
                ('asset_name', models.CharField(max_length=100, verbose_name='Asset Name')),
                ('manufacturer', models.CharField(choices=[('hp', 'HP'), ('dell', 'DELL'), ('apple', 'APPLE')], default='hp', max_length=200, verbose_name='Maunfacturer')),
                ('model', models.CharField(max_length=200, verbose_name='Asset Model')),
                ('category', models.CharField(choices=[('it', 'IT EQUIPMENT'), ('leisure', 'LEISURE')], default='it', max_length=100)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=65)),
            ],
        ),
    ]
